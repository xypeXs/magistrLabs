...
# resnet - полностью обученная, классифицируем на ней
# замораживаем, но оставшиеся слои модели - не трогаем, сравнить с п.1
# изменить обучаемые слои: ввести доп. нейроны и добавить слои, сравнить с п.1-2

# на опр. выборке сравнить рез-ты исходной и дообученной сетей
# заморозить/добавить слои
# 1. дообучить, 2. добавить полносвязный слой
